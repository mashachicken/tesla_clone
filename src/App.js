...
function App() {
  ...
  return (
    <div className="App">
      ...
      <div style={vidStyle}>
        <video width='100%' className="hero-video hide-on-mobile" poster="/tesla_theme/assets/img/careers/hero-video-poster.jpg?20170710" autoPlay={true} muted="" loop={true}>
